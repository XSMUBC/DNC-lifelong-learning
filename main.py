...
def run(args):
    ...
    # Callbacks for evaluating and plotting generated / reconstructed samples #xsm xsm
    sample_cbs = [
    ...
    #--------------------#
    #----- TRAINING -----#   ## xsm xsm xsm xsm training beginning
    #--------------------#
    ...
    # Train model  #xsm xsm 
    train_cl(
        model, train_datasets, replay_mode=args.replay, dnclen=args.dnc, z0=torch.tensor([]), scenario=scenario, classes_per_task=classes_per_task,
    ...
    print("training time:",training_time) #xsm

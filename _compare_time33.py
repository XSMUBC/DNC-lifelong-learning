...
#from DNCmaster.src.controller_implementations.dnc.dnc import *
#from DNCmaster.src.controller_implementations.feedforward import *
...
# expirimental task parameters.# xsm xsm define three scenarios and two tasks 
...
def get_results(args):
    ...
    if not os.path.isfile('{}/prec-{}.txt'.format(args.r_dir, param_stamp)):
        print(" ... running ... ")
        main.run(args)
#        print("here main run with parameters")
    # -get results-dict
    dict = utils.load_object("{}/dict-{}".format(args.r_dir, param_stamp))
    # -get average precisions & trainig-times # xsm xsm all results 
...
# xsm xsm command for run the code 
...
if __name__ == '__main__':
   ...
   ## CNN-DNC-based 
    ...
    args.replay = "none"  # xsm no replay
    args.distill = True
    args.feedback = True  # xsm no feedback
    args.dnc = True  # xsm cnn-dnc is applied
    DNCKD = {}
